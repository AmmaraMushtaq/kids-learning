  ...
  <button><ArrowBack/></button>
    ...
    <Box sx={{ Width: '100%', flexGrow: 1 }}>
      ...
      <SwipeableViews
        ...
        enableMouseEvents
      >
        {ColouredPageData.map((step, index) => ( 
      ...
      <MobileStepper
        ...
        <Button
            ...
            onClick={handleNext}
            disabled={activeStep === ColouredPageData.length - 1}
          >
            Next
            {theme.direction === 'rtl' ? (
              <KeyboardArrowLeft />
...
export default PictureWithHaroof;
