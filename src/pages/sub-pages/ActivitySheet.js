  ...
  <button><ArrowBack/></button>
    ...
    <Box sx={{ Width: '100%', flexGrow: 1 }}>
      ...
      >
        ...
        {similarHaroofActivitySheetsData.map((step, index) => (
          <div key={step.label}>
      ...
      style={{justifyContent:'center'}}
        steps={similarHaroofActivitySheetsData.length}
        position="static"
        ...
        nextButton={
          <Button
            size="small"
            onClick={handleNext}
            disabled={activeStep === similarHaroofActivitySheetsData.length - 1}
          >
            Next
            {theme.direction === 'rtl' ? (
              <KeyboardArrowLeft />
